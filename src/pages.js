...
function PageGiveClasses (req, res) {
    ...
    // se tiver dados
    /* const isNotEmpty = Object.keys(data).length > 0 // tem dados?? boolean
    if (isNotEmpty) { // Se sim

        data.subject = getSubject(data.subject)

        //adicionar dados a lista de proffys
        proffys.push(data)
        return res.redirect("/study") // e redirecionar a pagina study
    }
    // se não tiver dados, mostrar a página give-classes */
